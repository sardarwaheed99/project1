...
<section class="content">
  ...
  <td> <a class="btn btn-block bg-gradient-primary" href="/project/order/create/{{$y->id}}"> Place Order </td>  
  
  <td> <a class="btn" href="{{url('cart/delete/'.$y->id)}}"><i class="fa fa-trash"></i></a> 
   <a class="btn" href="/project/cart/edit/{{$y->id}}"><i class="fa fa-pencil"></i></a>  </td>
